...
- Add linting and update test command (#56)
- Add Dependabot configuration for automated dependency updates (#52)
- Remove CodeQL analysis workflow (#48)

### Chores

- Upgrade to ESLint v9 and migrate to a flat config (`eslint.config.mjs`) (#45)
- Optimize ESLint for UserScript and Vitest development (#46)

### Dependencies

- Bump Dexie.js from 4.2.1 to 4.3.0 (#55)
- Bump Rollup from 4.53.1 to 4.59.0 (#50)
- Bump various development dependencies.

### Documentation

- Update reporting method in Code of Conduct to use the private vulnerability reporting feature.

### Fixes

- Rename CI workflow file and update branch references from `main` to `master` (#51)
- Resolve "Unexpected lexical declaration in case block" linting error (#47)
